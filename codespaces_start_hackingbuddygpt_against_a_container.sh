...
wintermute LinuxPrivesc --llm.api_key=$OPENAI_API_KEY --llm.model=o1-mini --llm.context_size=8192 --conn.host=192.168.122.151 --conn.username=lowpriv --conn.password=trustno1 --conn.hostname=test1
